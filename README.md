...
1. You must have Python installed on system PATH or other OS' equivalent before running this program. To do so, go to https://www.python.org/downloads/ and during installation confirm that Python is added to PATH.
...
3. Open a command terminal/PowerShell and navigate to the directory where this project is stored. This can be done through the command `cd C:\path\to\repository\2322-24135194`
